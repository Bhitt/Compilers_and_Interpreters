			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -3:
						break;
					case 3:
						{return (new Yytoken(PLUS, yytext()));}
					case -4:
						break;
					case 4:
						{return (new Yytoken(MINUS, yytext()));}
					case -5:
						break;
					case 5:
						{return (new Yytoken(MUL, yytext()));}
					case -6:
						break;
					case 6:
						{return (new Yytoken(DIV, yytext()));}
					case -7:
						break;
					case 7:
						{return (new Yytoken(MOD, yytext()));}
					case -8:
						break;
					case 8:
						{return (new Yytoken(LT, yytext()));}
					case -9:
						break;
					case 9:
						{return (new Yytoken(EQUAL, yytext()));}
					case -10:
						break;
					case 10:
						{return (new Yytoken(GT, yytext()));}
					case -11:
						break;
					case 11:
						{return (new Yytoken(EXCL, yytext()));}
					case -12:
						break;
					case 12:
						{return (new Yytoken(SEMICOLON, yytext()));}
					case -13:
						break;
					case 13:
					...
					case -14:
						break;
					case 14:
						{return (new Yytoken(PERIOD, yytext()));}
					case -15:
						break;
					case 15:
						{return (new Yytoken(LPAREN, yytext()));}
					case -16:
						break;
					case 16:
						{return (new Yytoken(RPAREN, yytext()));}
					case -17:
						break;
					case 17:
						{return (new Yytoken(LBRACE, yytext()));}
					case -18:
						break;
					case 18:
						{return (new Yytoken(RBRACE, yytext()));}
					case -19:
						break;
					case 19:
						{return (new Yytoken(LBRACKET, yytext()));}
					case -20:
						break;
					case 20:
						{return (new Yytoken(RBRACKET, yytext()));}
					case -21:
						break;
					case 21:
						{return (new Yytoken(INTCONST, yytext()));}
					case -22:
						break;
					case 22:
						{;}
					...
					case -26:
						break;
					case 26:
						{return (new Yytoken(LTEQ, yytext()));}
					case -27:
						break;
					case 27:
						{return (new Yytoken(COMP, yytext()));}
					case -28:
						break;
					case 28:
						{return (new Yytoken(GTEQ, yytext()));}
					case -29:
						break;
					case 29:
						{return (new Yytoken(DNE, yytext()));}
					case -30:
						break;
					case 30:
						{return (new Yytoken(AND, yytext()));}
					case -31:
						break;
					case 31:
						{return (new Yytoken(OR, yytext()));}
					case -32:
						break;
					case 32:
						{return (new Yytoken(DOUBLECONST, yytext()));}
					case -33:
						break;
					case 33:
					...
					case -35:
						break;
					case 35:
						{return (new Yytoken(NEW, yytext()));}
					case -36:
						break;
					case 36:
						{return (new Yytoken(FOR, yytext()));}
					case -37:
						break;
					case 37:
						{return (new Yytoken(INT, yytext()));}
					case -38:
						break;
					case 38:
						{return (new Yytoken(INTCONST, yytext()));}
					...
					case -40:
						break;
					case 40:
						{return (new Yytoken(TRUE, yytext()));}
					case -41:
						break;
					case 41:
						{return (new Yytoken(THIS, yytext()));}
					case -42:
						break;
					case 42:
						{return (new Yytoken(VOID, yytext()));}
					case -43:
						break;
					case 43:
						{return (new Yytoken(BREAK, yytext()));}
					case -44:
						break;
					case 44:
						{return (new Yytoken(CLASS, yytext()));}
					case -45:
						break;
					case 45:
						{return (new Yytoken(FALSE, yytext()));}
					case -46:
						break;
					case 46:
					...
					case -47:
						break;
					case 47:
						{return (new Yytoken(READLN, yytext()));}
					case -48:
						break;
					case 48:
					...
					case -50:
						break;
					case 50:
						{return (new Yytoken(DOUBLE, yytext()));}
					case -51:
						break;
					case 51:
					...
					case -52:
						break;
					case 52:
						{return (new Yytoken(EXTENDS, yytext()));}
					case -53:
						break;
					case 53:
						{return (new Yytoken(PRINTLN, yytext()));}
					case -54:
						break;
					case 54:
						{return (new Yytoken(NEWARR, yytext()));}
					case -55:
						break;
					case 55:
						{return (new Yytoken(INTERFACE, yytext()));}
					case -56:
						break;
					case 56:
						{return (new Yytoken(IMPLEMENTS, yytext()));}
					case -57:
						break;
					case 57:
						{;}
